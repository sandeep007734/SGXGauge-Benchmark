...
/*          snprintf(buf, BUFSIZE, "AISHAPRINT FILE: %s LINE:%d p[0]: %d.\n", __FILE__, __LINE__, p[0]);
            ocall_print_string(buf);
            memset(buf, '\0', BUFSIZE);
*/
            sum +=
...
/*          snprintf(buf, BUFSIZE, "AISHAPRINT FILE: %s LINE:%d p[124]: %d.\n", __FILE__, __LINE__, p[124]);
            ocall_print_string(buf);
            memset(buf, '\0', BUFSIZE);

            snprintf(buf, BUFSIZE, "AISHAPRINT FILE: %s LINE:%d sum: %d.\n", __FILE__, __LINE__, sum);
            ocall_print_string(buf);
            memset(buf, '\0', BUFSIZE);
*/
            p +=  128;
...
/*    snprintf(buf, BUFSIZE, "AISHAPRINT FILE: %s LINE:%d BENCHMARK SUM SUM SUM SUM SUM SUM: [%d].\n", __FILE__, __LINE__, sum);
    ocall_print_string(buf);
    memset(buf, '\0', BUFSIZE); 
*/
...
//  extern FILE *ftiming;
    ...
    if (mb / secs < 1.) {
        ...
        snprintf(buf, BUFSIZE, "%s %.6f\n", tempbuf, mb/secs);
        ocall_print_string(buf);
        memset(buf, '\0', BUFSIZE);
    } else {
        //(void) fprintf(ftiming, "%.2f\n", mb/secs);
        snprintf(buf, BUFSIZE, "%s %.2f\n", tempbuf, mb/secs);
        ocall_print_string(buf);
        memset(buf, '\0', BUFSIZE);
    }
}
