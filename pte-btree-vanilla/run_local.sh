...
if [ $EXEC_TYPE -eq 1 ];then
    ...
    BENCHHOME="/home/sandeep/Desktop/work/phd/benchmark-work/flaas-bench/pte-btree"
...
MAIN_DIR="$(pwd)/evaluation/${EXP_NAME}/${BENCH}/graphene-"$PREFIX"-"$(date +"%Y%m%d-%H%M%S")
mkdir -p $MAIN_DIR
